...
class TimeEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post time_entries_url, params: { time_entry: { date: @time_entry.date, summary: @time_entry.summary, time_spent: @time_entry.time_spent } }
    end
  ...
  test "should update time_entry" do
    patch time_entry_url(@time_entry), params: { time_entry: { date: @time_entry.date, summary: @time_entry.summary, time_spent: @time_entry.time_spent } }
